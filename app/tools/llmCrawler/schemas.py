...
class LlmCrawlerJobStatusResponse(BaseModel):
    ...
    bot_visibility_score: float | None = None
    bot_visibility_scores: Dict[str, Any] | None = None
    bot_visibility_confidence: float | None = None
    bot_visibility_coverage: Dict[str, Any] | None = None
    ...
    content_segmentation: Dict[str, Any] | None = None
    ...
    segment_tree: List[Dict[str, Any]] | None = None
    main_content_nodes: List[int] | None = None
    noise_nodes: List[int] | None = None
